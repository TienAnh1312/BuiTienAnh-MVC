...
namespace L9_SessionCookie.Models​;

public partial class Lab9AspContext : DbContext
{
    public Lab9AspContext()
    {
    }

    public Lab9AspContext(DbContextOptions<Lab9AspContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-53K42V9;Database=Lab9ASP;uid=sa;pwd=123456;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C882B3FE659D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27CA0CA6CB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC27C86C1E5D");
